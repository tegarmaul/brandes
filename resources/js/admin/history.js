...
function applyFilter(keyword, date) {
    ...
    rows.forEach(row => {
        ...
        // Data waktu biasanya ada di atribut atau teks tertentu
        // Di history.blade.php: <span class="time-main">2026-05-03 12:00:00</span>
...
function downloadRekap() {
    ...
    downloadLink.download = 'rekap-history-akses.csv';
    downloadLink.click();
