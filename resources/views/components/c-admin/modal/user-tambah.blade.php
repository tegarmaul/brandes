...
<div class="modal-overlay" id="userTambahModalOverlay" onclick="closeTambahModalUserOutside(event)">
    <div class="modal modal-tambah">
            ...
            <div class="form-inputs-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="number" name="fingerprint_id" class="form-control with-icon" placeholder="Masukan ID user" min="1" max="127" inputmode="numeric">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="pin" id="userPinInput" class="form-control with-icon" placeholder="Masukan PIN user" maxlength="6" inputmode="numeric" required>
                        
                        {{-- Toggle Visibility Eye (Lihat PIN) --}}
                        <button type="button" class="toggle-eye" onclick="toggleUserPin()" title="Tampilkan PIN">
                            <svg id="userEyeIcon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="form-footer">
            <button type="submit" class="btn-submit" form="addUserForm">Simpan</button>
        </div>
