            ...
            <table id="adminTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge-status {{ isset($admin->status) && $admin->status === 'nonaktif' ? 'nonaktif' : 'aktif' }}">
                                {{ isset($admin->status) && $admin->status === 'nonaktif' ? 'Nonaktif' : 'Aktif' }}
                            </span>
                        </td>
                        <td>
                            <div class="aksi-wrap">
            ...
            <form action="{{ route('admin.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="nama" class="form-control with-icon" placeholder="Masukan nama admin" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="pin" class="form-control with-icon" placeholder="Masukan PIN admin" maxlength="6" inputmode="numeric" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper select-wrapper">
                        ...
                        <select name="role" class="form-control with-icon">
